				...
				<div class="row">
									...
									<div class="p-5">
										<div class="author-profile">
											<div class="author-media">
												<img src="{{(!empty($userid->photo))?url('upload/user_image/'.$userid->photo):url('upload/no_image.jpg')}}" alt="">
					...
					<div class="col-xl-9 col-lg-8">
						<div class="card  card-bx m-b30">
							...
							<form class="profile-form" method="POST" action="{{route('update.user.profile')}}">
								@csrf
