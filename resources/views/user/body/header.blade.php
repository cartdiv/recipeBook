    ...
    <a href="index.html" class="brand-logo">
        ...
        {{-- <svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="134.01" height="48.365" viewBox="0 0 134.01 48.365">
          <g id="Group_38" data-name="Group 38" transform="translate(-133.99 -40.635)">
            <text id="Job_Admin_Dashboard" data-name="RecipeBook Admin Dashboard" transform="translate(134 85)" fill="#787878" font-size="12" font-family="Poppins-Light, Poppins" font-weight="300"><tspan x="0" y="0">RecipeBook Admin Dashboard</tspan></text>
            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="{{(!empty($user->photo))?url('upload/user_image/'.$user->photo):url('upload/no_image.jpg')}}" width="20" alt="">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="{{route('user.change.password')}}" class="dropdown-item ai-icon">
